...
Use the current OpenSpec acceptance criteria and Core delivery endpoint to determine what completion means.
...
| Plugin installed and available | Native loading/catalog evidence in addition to static package validation |
