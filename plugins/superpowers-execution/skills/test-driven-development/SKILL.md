...
Use the current OpenSpec acceptance criteria and Core verification rules to choose the scope.
...
Use [verification before completion](../verification-before-completion/SKILL.md) for the evidence report.
For uncertain failures, use the existing systematic-debugging supply described in [debugging correspondence](../../DEBUGGING.md).
