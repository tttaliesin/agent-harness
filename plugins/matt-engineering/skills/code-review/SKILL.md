...
Use the existing Core workflow and OpenSpec change as the authority for scope and review gates.
...
4. If no specification exists, report that the Spec axis is unavailable and complete the Standards review.
...
Apply the existing Core review gate and severity rules when deciding readiness; one axis cannot hide a failure in the other.
