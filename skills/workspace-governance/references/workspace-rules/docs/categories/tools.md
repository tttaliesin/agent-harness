...
범용 [Markdown authoring](https://github.com/tttaliesin/developer-skills/tree/main/skills/markdown-authoring)과 [GitHub operations](https://github.com/tttaliesin/developer-skills/tree/main/skills/github-operations) 절차는 Developer Skills가 소유

공통 Harness는 기존 스킬·정책과 부족한 실행 지원 코드를 Developer Skills 한 저장소에서 관리
...
저장소의 runtime·package manager·task 진입점은 [개발 도구 기준](https://github.com/tttaliesin/developer-skills/blob/main/skills/development-tooling/references/development-tooling.md)에 따라 선택한다.
